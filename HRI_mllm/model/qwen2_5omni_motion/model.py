...
@auto_docstring(
    custom_intro="""
    The full Qwen2.5OmniMotion model, a multimodal model composed of 3 sub-models:
    - [`Qwen2_5OmniThinkerForConditionalGeneration`]:
    a causal auto-regressive transformer takes text, audio, image, video as input and predict text tokens.
    - [`Qwen2_5OmniTalkerForConditionalGeneration`]:
    a causal auto-regressive transformer takes thinker hidden states and response as input and predict speech tokens.
...
class Qwen2_5OmniMotionForConditionalGeneration(Qwen2_5OmniForConditionalGeneration):
...
__all__ = [
    "Qwen2_5OmniMotinForConditionalGeneration",
