...
class KimiAMotionContent:
    def __init__(
        self, audio_token_ids=None, motion_token_ids=None, text_token_ids=None, is_continuous_mask=None, audio_token_loss_mask=None, motion_token_loss_mask=None, text_token_loss_mask=None
    ):
        self.audio_token_ids: list[int] = audio_token_ids or []
        self.motion_token_ids: list[int] = motion_token_ids or []
        ...
        self.motion_token_loss_mask: list[int] = motion_token_loss_mask or []
    ...
    def motion_append(self, index: int, motion_token_loss_mask: bool = False):
        self.motion_token_ids.append(index)
        self.motion_token_loss_mask.append(motion_token_loss_mask)
    ...
    def motion_extend(self, ids: list[int], motion_token_loss_mask: bool = False):
        self.motion_token_ids.extend(ids)
        self.motion_token_loss_mask.extend([motion_token_loss_mask] * len(ids))
    ...
    def motion_prepend(self, index: int, motion_token_loss_mask: bool = False):
        self.motion_token_ids = [index] + self.motion_token_ids
        self.motion_token_loss_mask = [motion_token_loss_mask] + self.motion_token_loss_mask
    ...
    def motion_pretend(self, ids: list[int], motion_token_loss_mask: bool = False   ):
        self.motion_token_ids = ids + self.motion_token_ids
        self.motion_token_loss_mask = [motion_token_loss_mask] * len(ids) + self.motion_token_loss_mask


    def merge(self, other: "KimiAMotionContent"):
        self.audio_token_ids.extend(other.audio_token_ids)
        self.motion_token_ids.extend(other.motion_token_ids)
        ...
        self.motion_token_loss_mask.extend(other.motion_token_loss_mask)
    ...
    def to_tensor(self) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        return (
            ...
            torch.tensor([self.motion_token_ids], dtype=torch.long),
            ...
            torch.tensor([self.motion_token_loss_mask], dtype=torch.bool),
