...
from HRI_mllm.model.kimi_motion import MoonshotKimiaMotionForCausalLM
...
class KimiAudioMotionModel(MoonshotKimiaMotionForCausalLM):
    ...
    def export_model(input_dir, output_dir):
        ...
        kimiaudio = KimiAudioMotionModel.from_pretrained(input_dir)

        print("Saving Kimi-Audio LM to {}".format(output_dir))
        audio_model = MoonshotKimiaMotionForCausalLM(kimiaudio.config)
...
if __name__ == "__main__":
    ...
    if args.action == "init_from_pretrained":
        ...
        model = KimiAudioMotionModel.init_from_pretrained(args.model_name, model_load_kwargs={})

        os.makedirs(args.output_dir, exist_ok=True)
        # save model
        model.save_pretrained(args.output_dir)
    elif args.action == "export_model":
        KimiAudioMotionModel.export_model(args.input_dir, args.output_dir)
    else:
