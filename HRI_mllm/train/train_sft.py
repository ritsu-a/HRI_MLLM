...
from HRI_mllm.external.qwen2_vl_finetune.src.trainer import QwenSFTTrainer
from HRI_mllm.external.qwen2_vl_finetune.src.dataset import make_supervised_data_module
from HRI_mllm.external.qwen2_vl_finetune.src.params import DataArguments, ModelArguments, TrainingArguments
from HRI_mllm.external.qwen2_vl_finetune.src.train.train_utils import get_peft_state_maybe_zero_3, get_peft_state_non_lora_maybe_zero_3, safe_save_model_for_hf_trainer
import pathlib
from liger_kernel.transformers import apply_liger_kernel_to_qwen2_vl, apply_liger_kernel_to_qwen2_5_vl
from HRI_mllm.external.qwen2_vl_finetune.src.train import replace_qwen2_5_with_mixed_modality_forward, replace_qwen_2_with_mixed_modality_forward
...
def train():
    ...
    processor = Qwen2_5OmniProcessor.from_pretrained(model_args.model_id)
