...
class AudioHandler:
    ...
    """
    def __init__(self,format=pyaudio.paInt16,rate=24000,chunk=1024):
        # Audio parameters
        self.format = format
        ...
        self.playback_buffer = queue.Queue(maxsize=1000)
    ...
    def play_audio(self, audio_data: bytes):
        """Add audio data to the buffer and wait for playback to complete"""
        self.playback_complete_event.clear()        #clear playing complete event
        try:
    ...
    def wait_for_playback_complete(self, timeout = None):
        ...
        self.playback_complete_event.wait(timeout)
