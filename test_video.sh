python HRI_mllm/test/test_adaptor_jsonl_comparison.py \
    ...
    --motion_adaptor_path /root/workspace/HRI_MLLM/output_disk0/motion_adaptor_v12/kimi_audio_motion_gpt2_brainco_finetune_beat_single_motion/checkpoints/epoch_2800.pt \
